...
(123, 123456789, 'nocturna', 'lectiva', 1, 'cerrada'),
...
CREATE TABLE IF NOT EXISTS `juicios_evaluativos` (
  ...
  `observacion` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
(2, 'Análisis y desarrollo de software', 4000, 'tecnologo');
