...
$sql = "SELECT c.id, c.nombre_competencia, COUNT(r.id) AS 'cant_rae', c.total_horas FROM competencias c LEFT JOIN resultados_aprendizaje r ON r.id_competencia = c.id WHERE id_programa_formacion = " . $_GET["programa"] . " GROUP BY c.id";
